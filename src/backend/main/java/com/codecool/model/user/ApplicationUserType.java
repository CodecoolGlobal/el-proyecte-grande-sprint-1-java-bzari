...
import static com.codecool.security.ApplicationUserPermission.POST_READ;
import static com.codecool.security.ApplicationUserPermission.POST_WRITE;

@Getter
public enum ApplicationUserType {
    USER(Sets.newHashSet(POST_READ)),
    MODERATOR(Sets.newHashSet(POST_READ)),
    ADMIN(Sets.newHashSet(POST_WRITE, POST_READ));
