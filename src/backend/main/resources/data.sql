...
INSERT INTO application_user (email, password, type, username) VALUES ('asd@gmail.com', 'asd', 'ADMIN','IamGod666');
INSERT INTO application_user (email, password, type, username) VALUES ('anot@gmail.com', 'asd', 'USER','IamNotGod666');
...
-- Great Barrier reef - locationId:1
    INSERT INTO location (climate, crisis, description, name, sound, video, continent_id, altitude, longitude) VALUES ('Tropic','Rising ocean temperatures driven by human emissions of greenhouse gases have caused five mass bleaching events along the reef in 1998, 2002, 2016, 2017 and 2020. Hughes told the Guardian he believes a sixth mass bleaching event is now unfolding, and that it was not mild or local.', 'Great Barrier Reef, Extensive complex of coral reefs, shoals, and islets in the Pacific Ocean, off the northeastern coast of Australia. The largest deposit of coral in the world, it extends for more than 1,250 mi (2,000 km) along the coast of Queensland and has an area of some 135,000 sq mi (350,000 sq km).', 'Great Barrier reef', null, null, 1, 512, -20);
    -- Manta Ray
